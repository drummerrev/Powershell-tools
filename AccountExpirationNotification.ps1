<#
.Synopsis
   Script to Automated Email Reminders when Users Accounts are Set to Expire.
.DESCRIPTION
   Script to Automated Email Reminders when Users Accounts are Set to Expire.
   Based on Password Expiry Notification Script by:
   Robert Pearman (Cloud & Data Center MVP)
   WindowsServerEssentials.com
   Version 2.3 March 2017
   Edits for Expiry Use made by Jeremy Long - June 2017
...
# Get Users From AD who are Enabled, Accounts Expiring and are Not Currently Expired
...
$users =  Search-ADAccount -AccountExpiring -TimeSpan "14"
# Count Users
...
# Collect Users
$colUsers = @()
# Process Each User for Account Expiry
